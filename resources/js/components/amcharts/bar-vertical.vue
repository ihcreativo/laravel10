...
export default {
    ...
    data(){
        return {
            ...
            lc_campo_categoria: this.campo_categoria,
            lc_campo_valor: this.campo_valor,
            title: null,
            chart: null,
            datos: [],
            ejeCat: null,
    ...
    methods: {
        setCategoria:function(arg){
            this.lc_campo_categoria = arg;
        },
        setValor: function(arg){
            this.lc_campo_valor = arg;
        },
        exportar: function(){
            if(this.chart != null){
            ...
            if(Array.isArray(arg)){
                ...
                if(arg.length > 50){
                    ...
                    this.datos = (this.empty_category == '')? arg.slice(0, 50): arg.slice(0, 50).map(elm => {
                        if(elm[this.lc_campo_categoria] === ''){
                            elm[this.lc_campo_categoria] = this.empty_category;
                        }
                        return elm;
                    });
                }else{
        ...
        runAnimate: function(){
            if(this.chart != null){
                this.ejeCat.dataFields.category = this.lc_campo_categoria;
                this.chart.appear();
        ...
        preview: function(){
            ...
            a.forEach(elm => {
                var dt = new Object();
                dt[this.lc_campo_categoria] = elm;
        ...
        createChart: function(){
            ...
            this.listSeries.forEach((elm, indice) => {
				...
				serie.dataFields.categoryY = this.lc_campo_categoria;		// h-- ok
                ...
                if(boxType == 'columna'){
                    if(this.tooltip){
                        ...
                        if(this.lanzarevento != 'none'){
                            ...
                            serie.tooltip.events.on('hit', ev => {
                                ...
                                contexto.lc_campo_categoria = this.lc_campo_categoria;
                                contexto.lc_campo_valor = elm;
                                if(this.empty_category != '' && contexto[this.lc_campo_categoria] == this.empty_category){
                                    contexto[this.lc_campo_categoria] = "";
                                }
                    ...
                    serie.columns.template.events.on("hit", ev => {
                        ...
                        if(this.lanzarevento != 'none'){
                            var tm = contexto;
                            tm.lc_campo_categoria = this.lc_campo_categoria;
                            tm.lc_campo_valor = elm;
                            if(this.empty_category != '' && tm[this.lc_campo_categoria] == this.empty_category){
                                tm[this.lc_campo_categoria] = "";
                            }
