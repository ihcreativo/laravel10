...
export default {
    ...
    data(){
        return {
            ...
            label: null,
            paletas: {
                basica: ["#1cdddc","#a5d8eb","#fa9f9e","#b4c1c7","#ffded9","#b0f0a4","#aef0ff","#ffa9de","#a1b4ff","#ffcf9e","#febdd1","#72cccc"],
               ...
               // material: ["#f44336", "#e91e63", "#9c27b0", "#673ab7", "#3f51b5", "#2196f3", "#03a9f4", "#00bcd4", "#009688", "#4caf50", "#8bc34a", "#cddc39", "#ffeb3b", "#ffc107", "#ff9800", "#ff5722", "#795548", "#9e9e9e", "#607d8b"],
                material: ["#b2da9b","#fbd787","#f39391","#9dd2e5","#75bd99","#fda883","#b88ec7","#f0a2d8","#879ad4",],
                ...
                ihcreativo:["#1cdddc","#fe9903","#f05237","#814487","#b861c0","#018298","#31beab","#8ec543"],
                custom: []
            },
            themePaleta: '',
            _accion: null,
    ...
    methods: {
        ...
        setDatos: function(arg){
            if(Array.isArray(arg)){
                ...
                if(arg.length > 31){
                    this.overload = true;
                    this.datos = (this.empty_category == '')? arg.slice(0, 31): arg.slice(0, 31).map(elm => {
                        if(aux.includes(elm[this.campo_categoria])){
                            let ind = aux.findIndex(a => elm[this.campo_categoria] === a);
                            elm[this.campo_categoria] = txs[ind];
                        }
        ...
        setPaleta: function(arg){
            ...
            }else if(['basica', 'material', 'dataviz', 'kelly', 'frozen', 'moonrise','ihcreativo'].indexOf(arg) > -1){
                this.themePaleta = arg;
            }else if(/^\d+$/.test(arg)){
                let plt = ['basica', 'basica', 'material', 'dataviz', 'kelly', 'frozen', 'moonrise','ihcreativo'];
                let num = parseInt(arg);
                this.themePaleta = (num > 0 && num < 8)? plt[num]: 'basica';
            }else if(/#/.test(arg)){
