...
export default {
    ...
    methods: {
        ...
        setDatos: function(arg, cat=null, ptag='none'){
            ...
            if(ptag != 'none'){
                ...
                for(let i = 0; i < this.tags.length; i++){
                    this.tags[i].label.text = this.lc_pretag + "{valueX}" + this.porcentaje;
                }
            }
        ...
        setDatosGroup: function(data, group_a, group_b, val){
           // console.log('marca', group_a, group_b, val);
            ...
            this.setDatos(Object.values(tm));
        },
        ...
        createChart: function(){
            ...
            if(this.truncar){
                ...
                this.ejeCat.renderer.labels.template.maxWidth = 220;
            }
        ...
        createSerie: function(descriptor, name, color='void', indice=0){
            ...
            serie.stacked = true;
            serie.name = showtext;
            serie.dataFields.categoryY = this.lc_categoria;		// h-- ok
            serie.dataFields.valueX = descriptor;							// h-- ok
            if(this.tooltip){
