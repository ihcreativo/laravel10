...
export default {
    ...
    methods: {
        ...
        setPaleta: function(arg){
            ...
            }else if(['basica', 'material', 'dataviz', 'kelly', 'frozen', 'moonr'].indexOf(arg) > -1){
        ...
        setDatosGroup: function(data, group_a, group_b, val){
            ...
            data.forEach(elm => {
                ...
                if(tm[cate][campo] == undefined){tm[cate][campo] = 0;}
                tm[cate][campo] += elm[val];
                tm[cate].allsum += elm[val];
        ...
        createSerie: function(descriptor, name, color='void', indice=0){
            ...
            if(this.etiquetas){
                ...
                if(this.desapilar){
                    ...
                    tag.label.truncate = true;
                    tag.label.hideOversized = true;
                    tag.label.fill = am4core.color("#000");
