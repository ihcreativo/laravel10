...
<li class="menu d-none">
    ...
    <ul class="collapse px-0" id="components" data-bs-parent="#accordionExample">
        <li class="menu menu-heading h-auto mt-3 mx-0 px-0">
            <a href="" class="heading py-0 my-0 mt-0 pt-0">
